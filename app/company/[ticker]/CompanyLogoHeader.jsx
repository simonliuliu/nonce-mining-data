...
export default function CompanyLogoHeader({ ticker, company, color, headquarters, website }) {
  const [logoOk, setLogoOk] = useState(true);

  return (
    <div style={{ display: "flex", alignItems: "center", gap: 16, margin: "20px 0 0" }}>

      {/* Logo or fallback ticker badge */}
      {logoOk ? (
        <img
      ...
      <div>
        ...
        <div style={{ fontSize: 13, color: "var(--text3)", display: "flex", gap: 12, flexWrap: "wrap", marginTop: 4 }}>
          ...
          {website && (
            <>
              <span>·</span>
              <a href={website} target="_blank" rel="noopener" style={{ color: "var(--text3)" }}>
                Website ↗
              </a>
            </>
          )}
